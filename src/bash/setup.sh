...
4. Run the nextflow pipeline using the parameters: -profile singularity,upscb -c nextflow/upscb.config -params-file nextflow/nf-params.json -with-trace -with-report report_$(date "+%Y_%m_%d_%H_%M").html
